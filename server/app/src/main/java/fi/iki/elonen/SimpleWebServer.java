...
public class SimpleWebServer extends NanoHTTPD {
    ...
    private Response respond(Map<String, String> headers, String uri) {
        ...
        if (uri.startsWith("src/main") || uri.endsWith("src/main") || uri.contains("../")) {
            return createResponse(Response.Status.FORBIDDEN, MIME_PLAINTEXT, "FORBIDDEN: Won't serve ../ for security reasons.");
        }
        ...
        if (f.isDirectory()) {
            ...
            if (indexFile == null) {
                if (f.canRead()) {
                    ...
                    return createResponse(Response.Status.OK, MIME_HTML, listDirectory(uri, f));
                } else {
                    return createResponse(Response.Status.FORBIDDEN, MIME_PLAINTEXT, "FORBIDDEN: No directory listing.");
                }
            } else {
        ...
        return response != null ? response :
            createResponse(Response.Status.NOT_FOUND, MIME_PLAINTEXT, "Error 404, file not found.");
    }
